...
- 关于共享
> 某些单位，不许使用共享，包括强制关闭 Admin$, IPC$ 等，岂不知这些**管理共享**的本质意义，结果导致与安全策略复制故障等一系列问题。  
所以，如果你的**活动目录**出了问题，先检查一下自己这几天又装什么安全软件了，又关什么端口或服务了。你是否真的了解了这个安全软件所做的操作的原理。
...
- 就无意产生漏洞，举个不恰当的例子：   
家里的防盗门，结实吧？可是谁能想到江湖高人会通过**猫眼**伸个钢筋进来压动门把手把门打开呢？  好吧，打个铁补丁把猫眼补上。  
